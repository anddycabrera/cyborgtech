const features = [
    { 
      ...
      cta: 'Sandbox: Explore Text Analysis',
      link: '/dashboard/text-analysis'
    },
    { 
    ...
    { 
      icon: 'Translation-and-Summarization', 
      title: 'Translation and Summarization', 
      text: 'Bridge language barriers and condense lengthy texts to succinct summaries.', 
      cta: 'Sandbox: Explore Translation and Summarization',
      link: '/dashboard/translation-summarization'
    },
    { 
      ...
      cta: 'Sandbox: Explore Text Generation',
      link: '/dashboard/text-generation'
    },
    { 
      icon: 'Conversational-AI', 
      ...
      cta: 'Sandbox: Explore Conversational AI',
      link: '/dashboard/conversational-ai'
    },
  ];
