...
function MainContent() {
  return (
    <main className="container">
      <SandboxHeader/>
      <Analysis huggingFaceApi={HUGGINGFACE_API+'siebert/sentiment-roberta-large-english'} title={'English-Language Sentiment Classification'} description={'It enables reliable binary sentiment analysis for various types of English-language text. For each instance, it predicts either positive (1) or negative (0) sentiment.'}/>
