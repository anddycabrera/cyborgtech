...
const SubNavbar = () => {
  return (
    <div className="nav-scroller bg-body shadow-sm">
      ...
      <NavLink className="nav-link" activeClassName="active" aria-current="page" to="/dashboard/question-answering">Question Answering <span className="badge bg-light text-dark rounded-pill align-text-bottom">Coming soon</span></NavLink>
